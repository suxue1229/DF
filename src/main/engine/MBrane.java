...
public class MBrane {
    ...
    public void calculate(double mfH2CO3) throws Exception {
        ...
        while (true) {
            ...
            if (Jpn == Double.POSITIVE_INFINITY || Jpn == Double.NEGATIVE_INFINITY || Jpn == Double.NaN) {
        ...
        for (EIon ion : EIon.values()) {
            ...
            streamc.ion(ion).parcj((1 - parYt() * parBj(ion) * parTrjd(ion)) / (1 - parYt()) * streamf.ion(ion).parcj());
        }
